...
_magic_number = 10
_modified_time = 1492029471.7025511
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['datetime','date','now'] if __M_key in __M_locals_builtin_stored]))
