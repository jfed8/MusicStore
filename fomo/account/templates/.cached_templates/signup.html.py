...
_magic_number = 10
_modified_time = 1489795185.9888597
_enable_loop = True
_template_filename = 'C:/Users/klynty/fomo/fomo/account/templates/signup.html'
...
def render_body_center(context,**pageargs):
    ...
    try:
        ...
        form = context.get('form', UNDEFINED)
        __M_writer = context.writer()
        __M_writer('\r\n<h3>Sign up with FOMO</h3>\r\n<p>Please provide us with the information below to create an account.</p>\r\n')
        __M_writer(str( form ))
...
"""
__M_BEGIN_METADATA
{"filename": "C:/Users/klynty/fomo/fomo/account/templates/signup.html", "uri": "signup.html", "source_encoding": "utf-8", "line_map": {"28": 0, "38": 1, "43": 19, "48": 28, "54": 17, "60": 17, "66": 21, "73": 21, "74": 24, "75": 24, "81": 75}}
__M_END_METADATA
"""
