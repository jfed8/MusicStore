...
_magic_number = 10
_modified_time = 1490749498.4024377
_enable_loop = True
_template_filename = 'C:/Users/klynty/fomo/fomo/manager/templates/createuser.html'
...
def render_body_center(context,**pageargs):
    ...
    try:
        ...
        form = context.get('form', UNDEFINED)
        __M_writer = context.writer()
        __M_writer('\r\n<h3>Create User</h3>\r\n<p>Please complete the form below to create user</p>\r\n')
        __M_writer(str( form ))
...
"""
__M_BEGIN_METADATA
{"filename": "C:/Users/klynty/fomo/fomo/manager/templates/createuser.html", "uri": "createuser.html", "source_encoding": "utf-8", "line_map": {"28": 0, "38": 1, "43": 19, "48": 29, "54": 17, "60": 17, "66": 21, "73": 21, "74": 24, "75": 24, "81": 75}}
__M_END_METADATA
"""
